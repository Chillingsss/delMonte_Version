          ...
          <SheetContent side="left">
            ...
            >
              <Image
                ...
                width={152}
                height={152}
                className="w-32 h-24 transition-all group-hover:scale-110"
              />
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="secondary"
                size="icon"
                className="rounded-full bg-[#0e5a35] text-white"
              >
                ...
                >
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        size="icon"
                        className="bg-transparent rounded-lg text-white transition-colors hover:text-black md:h-8 md:w-8"
                      >
