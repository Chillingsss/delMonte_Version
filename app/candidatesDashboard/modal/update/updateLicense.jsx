	...
	useEffect(() => {
		setFormValid(
			...
			typeof data.license_number === "string" &&
				...
				// Check license master - either from new selection or existing data
				((data.license_master_id === "custom" &&
					data.customLicenseMaster.trim() !== "") ||
					(data.license_master_id && data.license_master_id !== "custom") ||
					selectedLicense?.license_master_name) &&
				// Check license type - either from new selection or existing data
				((data.license_type_id === "custom" &&
					data.customLicenseType.trim() !== "") ||
					(data.license_type_id && data.license_type_id !== "custom") ||
					selectedLicense?.license_type_name) &&
				!error
		);
	}, [data, error, selectedLicense]);
