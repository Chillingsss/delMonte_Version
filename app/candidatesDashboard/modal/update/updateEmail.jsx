	...
	const checkEmailDomain = async (email) => {
		try {
			...
			if (!response.data.isValid) {
				setEmailError(
					"This email domain appears to be invalid or non-existent"
				);
				setIsValidDomain(false);
				return false;
			}
							...
							>
								...
								<div className="space-y-1">
									...
									>
										...
										your email requires verification of:
									</p>
									<ul
										className={`text-sm ${
											isDarkMode ? "text-blue-300" : "text-blue-700"
					...
					{selectedEmailType && requiresPassword === null ? (
						...
						>
							<div className="text-center">
								<div
									className={`mx-auto flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full ${
										isDarkMode
								...
								>
									Please set up your password first before updating your email
									address.
								</p>
								<button
						...
						!isPinCodeSent && (
							...
							>
								...
								>
									...
									<p
										className={`mt-1 text-sm sm:text-base font-medium break-all ${
											isDarkMode ? "text-white" : "text-gray-900"
										}`}
									>
										{selectedEmailType === "primary"
											? candidateEmail
											: candidateAlternateEmail || "Not set"}
									</p>
								</div>
								...
								<div
									className={`mt-4 p-2.5 sm:p-3 rounded-lg text-xs sm:text-sm ${
										isDarkMode
											? "bg-gray-700/50 text-gray-300"
											: "bg-blue-50 text-blue-700"
									} border ${
										isDarkMode ? "border-gray-600" : "border-blue-100"
									}`}
								>
									<span className="font-medium">Note:</span> A verification code
									will be sent to your current primary email address.
								</div>
							</div>
						)
					)}
						...
						<div className="space-y-6">
							...
							>
								...
								>
									...
									>
										<span className="font-medium">Note:</span> Please check your
										email inbox for the verification code. If you do not see it,
						...
						<div className="space-y-6">
							...
							>
								...
								>
									...
									>
										<span className="font-medium">Note:</span> Please check your
										new email inbox for the verification code. If you do not see
